    ...
    return (
        ...
        <div className="tariffs-content row">
            <div className="tariffs-1">
                ...
                <span></span>
                <div>
                    <div className="include"><img src={mark} alt=""/>Базовая консультация менеджера без организации подбора автомобиля
                    </div>
                    <div className="no-include"><img src={cross} alt=""/>Проверка истории автомобиля, предварительная оценка повреждений,
                        предоставление отчёта CarFax
                    </div>
                    <div className="include"><img src={mark} alt=""/> Подача заявки на участии в аукционе по присланному номеру лота и
                        ставке по нему
                    </div>
                    <div className="include"><img src={mark} alt=""/>Участие в аукционе</div>
                    <div className="no-include"><img src={cross} alt=""/>Поиск нового автомобиля в случае проигрыша в аукционе. Повторяем
                        этот процесс столько раз сколько потребуется до победы!
                    </div>
                    <div className="include"><img src={mark} alt=""/>Оформление всех необходимых документов и организация доставки в
                        Беларусь
                    </div>
                    <div className="include"><img src={mark} alt=""/>Приёмка автомобиля в Беларуси</div>
                    <div className="no-include"><img src={cross} alt=""/>Сопровождение по подбору запчастей для вашего автомобиля из
                        внешних рынков
                    </div>
                    <div className="no-include"><img src={cross} alt=""/>Сопровождение в восстановлении автомобиля согласно предпочтениям
                        клиента
                    </div>
                </div>
            ...
            <div className="tariffs-2">
                ...
                <div>
                    ...
                    <div className="include"><img src={mark} alt=""/> Проверка истории автомобиля, предварительная оценка повреждений, предоставление отчёта
                        CarFax
                    </div>
                    <div className="include"><img src={mark} alt=""/> Участие в аукционе</div>
                    <div className="include"><img src={mark} alt=""/> Поиск нового автомобиля в случае проигрыша в аукционе. Повторяем этот процесс столько
                    ...
                    <div className="include"><img src={mark} alt=""/> Приёмка автомобиля в Беларуси</div>
                    <div className="no-include"><img className="delivery-cross" src={cross} alt=""/> Сопровождение по подбору запчастей для вашего автомобиля из внешних рынков</div>
                    <div className="no-include"><img src={cross} alt=""/> Сопровождение в восстановлении автомобиля согласно предпочтениям клиента</div>
                    <div className="no-include fake"><img src={cross} alt=""/> Сопровождение в восстановлении автомобиля согласно предпочтениям клиента</div>
                </div>
