				...
				<div className="col-12 delivery-content">
            		...
            		<div key="eu" className="delivery-block fade-in">
						<div className="delivery-left eu">
							...
							<div className="delivery-steps"><div>4</div>Доставка автомобиля в порт, загрузка в контейнер и отслеживание
								до прибытия в Беларусь
							</div>
						</div>
						<div className="delivery-right eu">
							<div className="delivery-steps delivery-steps3"><div>3</div>Оформление заявки, консультация и предварительный подбор
								автомобиля менеджером MOSTAUTO
							</div>
							<div className="delivery-steps"><div>2</div>Заключение договора, подбор автомобиля по заданным требованиям и
								согласование к торгам
							</div>
							<div className="delivery-steps"><div>1</div>Победа в торгах и оформление документов для оплаты и доставки
